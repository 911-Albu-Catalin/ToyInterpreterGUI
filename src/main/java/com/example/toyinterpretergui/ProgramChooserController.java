    ...
    private void displayProgram(ActionEvent actionEvent) {
        ...
        if (selectedStatement == null) {
            ...
            try {
                ...
                ProgramState programState = new ProgramState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyHeap(), new MySemaphoreTable(), selectedStatement);
...
//        allStatements.add(ex19);
        IStatement ex12 = new Compound(
                ...
                new Compound(
                        ...
                        new Compound(
                                new HeapAllocation("v1", new ValueExpression(new IntegerValue(1))),
                                new Compound(
                                        new CreateSemaphore("cnt", new HeapReading(new VariableExpression("v1"))),
                                        new Compound(
                                                new Fork(
                                                        new Compound(
                                                                new Acquire("cnt"),
                                                ...
                                                new Compound(
                                                        new Fork(
                                                                new Compound(
                                                                        ...
                                                                        new Compound(
                                                                                new HeapWriting("v1", new ArithmeticExpression('*',  new HeapReading(new VariableExpression("v1")), new ValueExpression(new IntegerValue(10)))),
                                                                                new Compound(
                                                                                        new HeapWriting("v1", new ArithmeticExpression('*',  new HeapReading(new VariableExpression("v1")), new ValueExpression(new IntegerValue(2)))),
                                                                                        new Compound(
                                                                                                new Print(new HeapReading(new VariableExpression("v1"))),
                                                                                                new Release("cnt")
                                                                                        )
                                                        ...
                                                        new Compound(
                                                                new Acquire("cnt"),
                                                                new Compound(
                                                                        new Print(new ArithmeticExpression('-', new HeapReading(new VariableExpression("v1")), new ValueExpression(new IntegerValue(1)))),
                                                                        new Release("cnt")
                                                                )
                                                        )
                                                )
