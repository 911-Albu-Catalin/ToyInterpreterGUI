    ...
    private void displayProgram(ActionEvent actionEvent) {
        ...
        if (selectedStatement == null) {
            ...
            try {
                ...
                ProgramState programState = new ProgramState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyHeap(),new MyBarrierTable(), selectedStatement);
                                        ...
                                        new Compound(
                                                ...
                                                new Compound(
                                                        ...
                                                        new Compound(
                                                                ...
                                                                new Compound(
                                                                        new NewBarrier("cnt", new HeapReading(new VariableExpression("v2"))),
                                                                        new Compound(
                                                                                new Fork(
                                                                                        new Compound(
                                                                                                new Await("cnt"),
