...
//        allStatements.add(ex19);
        ...
        IStatement ex12 = new Compound(new VariableDeclaration("v1", new RefType(new IntegerType())),
                new Compound(new VariableDeclaration("v2", new RefType(new IntegerType())),
                        new Compound(new VariableDeclaration("x", new IntegerType()),
                                new Compound(new VariableDeclaration("q", new IntegerType()),
                                        new Compound(new HeapAllocation("v1", new ValueExpression(new IntegerValue(20))),
                                                new Compound(new HeapAllocation("v2", new ValueExpression(new IntegerValue(30))),
                                                        new Compound(new NewLock("x"),
                                                                new Compound(new Fork(
                                                                        new Compound(new Fork(
                                                                                new Compound(new Lock("x"),
                                                                                        new Compound(new HeapWriting("v1", new ArithmeticExpression('-', new HeapReading(new VariableExpression("v1")), new ValueExpression(new IntegerValue(1)))),
                                                                                                new Unlock("x")))
                                                                        ),
                                                                                new Compound(new Lock("x"),
                                                                                        new Compound(new HeapWriting("v1", new ArithmeticExpression('*', new HeapReading(new VariableExpression("v1")), new ValueExpression(new IntegerValue(10)))),
                                                                                                new Unlock("x"))))
                                                                ),
                                                                        new Compound( new NewLock("q"),
                                                                                new Compound(new Fork(
                                                                                        new Compound( new Fork(
                                                                                                new Compound(new Lock("q"),
                                                                                                        new Compound(new HeapWriting("v2", new ArithmeticExpression('+', new HeapReading(new VariableExpression("v2")), new ValueExpression(new IntegerValue(5)))),
                                                                                                                new Unlock("q")))
                                                                                        ),
                                                                                                new Compound(new Lock("q"),
                                                                                                        new Compound(new HeapWriting("v2", new ArithmeticExpression('*', new HeapReading(new VariableExpression("v2")), new ValueExpression(new IntegerValue(10)))),
                                                                                                                new Unlock("q"))))
                                                                                ),
                                                                                        new Compound(new NoOperation(),
                                                                                                new Compound(new NoOperation(),
                                                                                                        new Compound(new NoOperation(),
                                                                                                                new Compound(new NoOperation(),
                                                                                                                        new Compound(new Lock("x"),
                                                                                                                                new Compound(new Print(new HeapReading(new VariableExpression("v1"))),
                                                                                                                                        new Compound(new Unlock("x"),
                                                                                                                                                new Compound(new Lock("q"),
                                                                                                                                                        new Compound(new Print(new HeapReading(new VariableExpression("v2"))),
