    ...
    private void displayProgram(ActionEvent actionEvent) {
        ...
        if (selectedStatement == null) {
            ...
            try {
                ...
                ProgramState programState = new ProgramState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyHeap(), new MyToySemaphoreTable(), selectedStatement);
        ...
        IStatement ex12 = new Compound(
                ...
                new Compound(
                        ...
                        new Compound(
                                ...
                                new Compound(
                                        new NewSemaphore("cnt", new HeapReading(new VariableExpression("v1")), new ValueExpression(new IntegerValue(1))),
                                        new Compound(
                                                new Fork(
                                                        new Compound(
                                                                new Acquire("cnt"),
